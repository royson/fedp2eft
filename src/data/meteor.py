...
class Meteor(evaluate.Metric):
    ...
    def _download_if_not_exist(self, dataset):
        try:
    ...
    def _download_and_prepare(self, dl_manager):
        self._download_if_not_exist('wordnet')    
        
        if NLTK_VERSION >= version.Version("3.6.5"):
            self._download_if_not_exist('punkt')
            self._download_if_not_exist('punkt_tab')  
        if NLTK_VERSION >= version.Version("3.6.6"):
            self._download_if_not_exist('omw-1.4')
